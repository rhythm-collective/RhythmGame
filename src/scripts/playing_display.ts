...
import {accuracyManager, TimeManager} from "./gameplay";
...
import {displayRouterDraw} from "./display_router";
...
export let scrollManager: ScrollManager = new ScrollManager();
...
export function prepareDisplay(tracks: Note[][]) {
    ...
    gameStateManager.setNotesEndTime();
...
export class DisplayManager {
    ...
    setCurrentTime(currentTime: number) {
        ...
        gameStateManager.endSongIfSongIsOver(currentTime);
    }
    ...
    getCanvasWidth(): number { //TODO: move these functions out to some other file
